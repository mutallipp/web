var stui = {
	...
	mobile: {
		...
		slide: function() {
			$.getScript("/static/uyvideo/phjs/flickity.pkgd.min.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript("/static/uyvideo/phjs/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
	...
	common: {
		bootstrap: function() {
			$.getScript("/static/uyvideo/phjs/bootstrap.min.js", function() {
		...
		headroom: function() {
			$.getScript("/static/uyvideo/phjs/headroom.min.js", function() {
				$("#header-top", function() {
